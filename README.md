...
Full-stack software engineer with a passion for making code that not only works, but is also a pleasure to work with in the future.

Most of my experience is with web applications, but I also enjoy making CLI tools.

Currently, I am happiest when making architectural changes, teaching & learning from teammates, & building reusable components to speed up future development cycles.
